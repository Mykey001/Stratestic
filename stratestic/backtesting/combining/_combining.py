...
class StrategyCombiner(StrategyMixin):
    ...
    **kwargs : additional keyword arguments
    ...
    def _check_input(strategies, method):
        ...
        StrategyInvalid
            If any strategy is not a valid StrategyMixin subclass.
        """
        ...
        for strategy in strategies:
            # Runtime validation: check if strategy inherits from StrategyMixin
            if not isinstance(strategy, StrategyMixin):
                raise StrategyInvalid(
                    ...
                    f"Ensure your strategy class inherits from stratestic.strategies.StrategyMixin"
                )
